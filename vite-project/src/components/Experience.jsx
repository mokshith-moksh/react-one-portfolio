...
import node from "../assets/mode.png";
...
const Experience = () => {
     const techs = [
        ...
        { id:3,src:javascript,title:'JS',style:"shadow-yellow-500"},
        { id:4,src:react,title:'REACT',style:"shadow-blue-600"},
        { id:5,src:redux,title:'REDUX',style:"shadow-purple-400"},
        { id:6,src:tailwind,title:'TAILWIND',style:"shadow-sky-400"},
        { id:7,src:node,title:'NODE',style:"shadow-green-500"},
        { id:8,src:mongoDB,title:'MONGODB',style:"shadow-green-600"},
